...
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/dolls/dolls4x_bicubic.png")#####for noise-free midd2006
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/table2/_input/dolls_big/depth_2_n.png")###mid 2006
LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/iccv15_test_imgs/input/venus/4_x_dep.png")###mid 2001
...
with tf.Session() as sess:
    model_path="/media/kenny/Data/trained_models/residual_bn_csvt_models/noisy/4x/full_model1/4x_ny_full_model.ckpt-95"
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/residual_bn_csvt_models/noisy/4x/results/venus4x_result.png")
    ######################computing rmse
