...
with h5py.File(train_h5F_addr,"r") as train_file:
    with tf.Session() as sess:
        ...
        #saver_full.restore(sess, "/home/yizuo/Data/eclipse_neon3_workspace_new/guided_srgan_multi_skip_version/train/noise_free_models/models_8x/full_models/8x_noisefree_gen_model_full.ckpt-13")
        for epo in range(epo_range):
            ...
            for ind in range(batch_total):
                ...
                if (ind+1)%3444==0:
                    save_path=saver_full.save(sess,"/media/kenny/Data/trained_models/residual_bn_csvt_models/noisy/8xsalt_5/full_model1/8x_nysalt5_full_model.ckpt",global_step=model_ind)
