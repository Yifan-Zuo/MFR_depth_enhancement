function [  ] = shuffle_training_data_4x( )
...
down_fac=4;
h5_des_name='/media/kenny/Data/training_data/gdsr_train_data/4x_data/shuffle_version/4x_training_data.h5';
h5_src_addr_pre='./4x_data/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
train_pat=220500;
