function [  ] = shuffle_training_data_16x( )
...
down_fac=16;
h5_des_name='/media/kenny/Data/training_data/gdsr_train_data/16x_data/shuffle_version/16x_training_data.h5';
h5_src_addr_pre='./16x_data/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
train_pat=220500;
