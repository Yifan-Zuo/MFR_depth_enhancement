function [  ] = shuffle_training_data_8x( )
...
down_fac=8;
h5_des_name='/media/kenny/Data/training_data/gdsr_train_data/8x_data/shuffle_version/8x_training_data.h5';
h5_src_addr_pre='./8x_data/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
train_pat=220500;
