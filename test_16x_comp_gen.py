...
#color_art = Image.open("/home/yizuo/Data/Desktop/iccv15_test_imgs/gth/venus/color_crop.png")####mid 2001
...
#gth_dep_art=Image.open("/home/yizuo/Data/Desktop/iccv15_test_imgs/gth/venus/depth_crop.png")###mid 2001
np_gth_dep=np.asarray(gth_dep_art)
val_gth_dep=np_gth_dep.astype(np.float32)/255.

#read test LR dep img
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/dolls/dolls16x_bicubic.png")#####for noise-free midd2006
LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/table2/_input/dolls_big/depth_4_n.png")###mid 2006
#LR_dep_art=Image.open("/home/yizuo/Data/Desktop/iccv15_test_imgs/input/venus/4_x_dep.png")###mid 2001
...
with tf.Session() as sess:
    model_path="/media/kenny/Data/trained_models/residual_bn_csvt_models/noisy/16x/full_model1/16x_ny_full_model.ckpt-16"
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/residual_bn_csvt_models/noisy/16x/results/dolls16x_result.png")
    ######################computing rmse
