...
#saver = tf.train.Saver(saving_var_list,max_to_keep=30)
saver_full=tf.train.Saver(max_to_keep=120)
#inten_restorer=tf.train.Saver(gen_inten_vars)
#dep_restorer=tf.train.Saver(gen_dep_vars)
model_ind=0
...
with h5py.File(train_h5F_addr,"r") as train_file:
    with tf.Session() as sess:
        sess.run(init_op)
        #inten_restorer.restore(sess, "/home/yifan/eclipse4.6_workspace/guided_srgan_multi_skip_version/train/2x_pretrain_Y/std5_version/results_modified_bncode/full_model1/2x_inten_cnn_model_full.ckpt-1")
        #dep_restorer.restore(sess,"/home/yifan/eclipse4.6_workspace/guided_srgan_multi_skip_version/train/2x_pretrain_D/std5_version/results_modified_bncode/full_model1/2x_dep_cnn_model_full.ckpt-10")
        #saver_full.restore(sess, "/home/yifan/eclipse4.6_workspace/guided_srgan_multi_skip_version/train/2x_pretrain_comp_gen/std5_version/modified_bn_code/full_model1/2x_comp_gen_model_full.ckpt-4")
